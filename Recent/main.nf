...
process TRIM_ALL_READS {
    ...
    container "vmichelet/trim_cut_recent"
...
process INDEX_CREATION {
    tag "index"
    container 'vmichelet/bowtie_recent'
...
process FEATURECOUNTS {
    ...
    container 'vmichelet/featurecounts_recent'
...
process deseq2 {
    tag "Running"
    container 'vmichelet/rdeseq2_recent'
...
workflow {
    ...
    deseq2(counts, file("data/Aureo_data2.csv"), file("data/GSE139659_IPvsctrl.complete.csv"),  file("data/deseq_fonc6.R") )
